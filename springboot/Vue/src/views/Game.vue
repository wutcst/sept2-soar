<template>
  <div class="container">
    <div class="map">
      ...
      <img class="arrow up" src="@/assets/up.png" />
      <img class="arrow down" src="@/assets/down.png" />
      <img class="arrow left" src="@/assets/left.png" />
      <img class="arrow right" src="@/assets/right.png" />
    </div>
    <div class="control">
      <button>Back</button>
      <button>Look</button>
